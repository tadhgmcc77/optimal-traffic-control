...
'''
python ..//..//plot_summary.py -i summary-heavy.xml,summary-low.xml,summary-medium.xml -l heavy,low,medium --xlim 0,2000 --ylim 0,20 -o total_summary.png -m meanWaitingTime --xlabel "time" --ylabel "waiting Time" --title "average waiting time"
'''